...
def _notification_preferences_defaults():
    return {
...
def notification_preferences(request):
    ...
    if request.method == 'POST':
        preferences = {
            'browser_notifications_enabled': request.POST.get('browser_notifications_enabled') == 'on',
            'job_alerts': request.POST.get('job_alerts') == 'on',
            'application_updates': request.POST.get('application_updates') == 'on',
            'payment_updates': request.POST.get('payment_updates') == 'on',
            'reminder_notifications': request.POST.get('reminder_notifications') == 'on',
            'marketing_updates': request.POST.get('marketing_updates') == 'on',
        }
